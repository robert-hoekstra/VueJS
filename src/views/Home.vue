  ...
  <div class="home">
    <main>
      <p>
        ...
        ></vue-typer>
        based in Amsterdam, The Netherlands. I have a great passion for bringing
        solutions to problems you did not even know you had.
      </p>

      <p class="extra">You can view projects I have worked on or check out my resume! </p>

      <p class="extra">At the bottom of the page are my contact details if you are in need of a developer or something else that requires a solution 😉</p>
...
footer section a:hover {
  ...
  padding-right: 0.5em;
  color: #42b983;
  animation: link-pulsate 1.5s infinite;
}
...
footer section ul li svg:hover {
  fill: #42b983;
  animation: border-pulsate 1.5s infinite;
}

@keyframes link-pulsate {
  0% {
    color: whitesmoke;
  }
  50% {
